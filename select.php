...
<li> <a href="resources.html"> Resources </a> </li>
			...
			<div id="contenttext">
				<div>
					<span class="titletext">Adhoc Results</span>
				</div>
			</div>
...
<strong> 
		This table contains entries from "tblUsers" that have been filtered by your parameters.   </strong> <br>
...
<?php
echo "<table id='table'>";
echo "<tr><th>Id</th><th>First Name</th><th>Last Name</th><th>Street Name</th><th>City</th><th>State</th><th>Zipcode</th><th>Email</th><th>Phone Number</th><th>Registration Date</th><th>Active/Inactive</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM tblUsers WHERE first_name LIKE '$targetfirstname' AND last_name LIKE '$targetlastname' AND state LIKE '$targetstate'"); 
    $stmt->execute();
