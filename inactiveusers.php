...
<li> <a href="resources.html"> Resources </a> </li>
			...
			<div id="contenttext">
				<div>
					<span class="titletext">Inactive Users</span>
				</div>
			</div>
...
<strong> 
		This table displays all of the inactive users in the "tblUsers" table.    </strong> <br>
...
try {
    ...
    $stmt = $conn->prepare("SELECT UserId, First_Name, Last_Name, Street_Name, City, State, Zipcode, Email, Phone_Number, Registration_Date, ACTIVE FROM tblUsers WHERE ACTIVE LIKE '$active' "); 
    $stmt->execute();
